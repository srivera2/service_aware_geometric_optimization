...
OUTPUT_ROOT = pathlib.Path(f"../results/{SCENE_NAME}_v2")
...
OUTSIDE_MARGIN_M      = 50.0     # metres beyond the zone's max X/Y extent to sample outside
BS_HEIGHT_M           = 50.0
BS_TARGET_Z_M         = 1.5
